...
public class CoolantCapsulePickupProgress : MonoBehaviour
{
    ...
    private void HandleItemCollected(ItemData _, int __)
    {
        if (gameProgressManager != null)
        {
            gameProgressManager.TryCompleteCoolantCapsule();
        }
    }
    ...
    private void RefreshPickupAvailability()
    {
        ...
        pickupInteractable.enabled = gameProgressManager != null
            && gameProgressManager.CurrentState == GameProgressState.FindCoolantCapsule;
    }
}
